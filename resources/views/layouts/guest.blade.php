...
<head>
	...
	<title>{{ $title ?? 'Livewire filament app' }}</title>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav m-auto mb-2 mb-lg-0">
					<li class="nav-item"> <a wire:navigate.hover class="nav-link" href="{{ route('fronted.index') }}">Home</a></li>
					{{-- <li class="nav-item "> <a class="nav-link" href="about.html">About Us</a></li> --}}
					<li class="nav-item "> <a wire:navigate.hover class="nav-link" href="{{ route('fronted.service') }}">Services</a></li>
					{{-- <li class="nav-item "> <a wire:navigate.hover class="nav-link" href="">Our Team</a></li> --}}
