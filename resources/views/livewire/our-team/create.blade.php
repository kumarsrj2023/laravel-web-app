<div>
    <div class="mb-8">
        <h1 class="text-4xl font-semibold border-b-4 border- inline-block border-blue-700">Add New Member-</h1>
    </div>
    <form action="" wire:submit="saveFormData">
        <div class="grid grid-cols-2 gap-6">
            ...
            <div class="relative flex flex-col items-center">
                ...
                @endif
                <div class="text-center absolute top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4" wire:loading wire:target="form.image">
                    <div role="status">
