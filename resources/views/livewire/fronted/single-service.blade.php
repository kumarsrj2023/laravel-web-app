            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        ...
                        <li class="list-inline-item">/ &nbsp; <a wire:navigate.hover href="{{ route('fronted.service') }}">Services</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a wire:navigate.hover href="">{{ $service->title }}</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <section class="section-sm">
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-12">
                   <h6 class=" mb-10">{{ $service->short_desc }}</h6>
