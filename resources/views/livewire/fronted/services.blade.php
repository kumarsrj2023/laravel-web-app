            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a wire:navigate.hover href="{{ route('fronted.index') }}">Home</a>
                        </li>
                        <li class="list-inline-item">/ &nbsp; <a wire:navigate.hover
                                href="">Services</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="icon-box-item text-center col-lg-4 col-md-6 mb-4">
                    <div class="rounded shadow py-5 px-4">
                        ...
                        <a wire:navigate.hover class="btn btn-sm btn-outline-primary"
                            href="{{ route('fronted.single.service', $service->id) }}">View Details <i
