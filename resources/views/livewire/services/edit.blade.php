<div>
    <div class="mb-8">
        <h1 class="text-4xl font-semibold border-b-4 border- inline-block border-blue-700">Update Service Data-</h1>
    </div>
    <div class="text-end my-4">
        <button wire:click="deleteRecored" type="button" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Delete</button>
    </div>

    <form action="" wire:submit="updateService">
        <div class="grid grid-cols-2 gap-6">
            ...
            <div>
                ...
                @else
                <img class="max-w-24 rounded-[50%]" src="{{ asset('storage/' . $form->oldIcon_class) }}">
                @endif
